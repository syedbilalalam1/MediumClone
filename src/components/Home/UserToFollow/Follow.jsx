...
const Follow = () => {
  ...
  return (
    <>
      {allUsers &&
        users?.map((user, i) => {
          const { username, bio, userImg, avatar, userId } = user;
          return (
            <div key={i} className="flex items-start gap-2 my-4">
              <div
                ...
                <div className="flex flex-col gap-1">
                  <h2 className="font-bold capitalize ui-text">{username}</h2>
                  <span className="leading-4 text-gray-500 text-sm line-clamp-2 ui-text">
